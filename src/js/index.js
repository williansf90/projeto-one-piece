...
// passo 1.2 e 1.3 - adicionar a classe "selecionado" no botão que o usuário clicou

botoes.forEach((botao, indice) => {
    botao.addEventListener("click", () => {

        // passo 1.3 - verificar se já exista um personagem selecionado, se sim, devemos remover a seleção dele     
        desselecionarBotao();
